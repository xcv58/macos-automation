...
| Old-to-new update (2.6 UI candidate) | Install 2.5 (41), update through Sparkle, and confirm the app relaunches as 2.6 (42) | Sparkle downloads, verifies, installs, and relaunches the signed app; the bundled helper remains build 42 | Release-owner waiver for 2.6 (42) on 2026-08-13: this candidate changes the main-app UI and import planning but does not change Sparkle, the background helper, or mount-prompt behavior. Automated bundle, embedded-version, signing, notarization, and appcast validation will run before publication; `xcv58` owns a post-release 2.5-to-2.6 Sparkle check. This waiver is candidate-specific and does not claim a physical old-to-new pass. |
